...
#import "TVServerPropertiesCell.h"
...
static NSString *ServerPropertiesCell=@"ServerPropertiesCell";
...
- (void)viewDidLoad
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"TVServerPropertiesCell" bundle:nil] forCellReuseIdentifier:ServerPropertiesCell];
    self.tableView.tableFooterView=[UIView new];
    self.navigationItem.rightBarButtonItem=[[UIBarButtonItem alloc]initWithTitle:NSLocalizedString(@"BUTTON_SAVE", @"Save") style:(UIBarButtonItemStylePlain) target:self action:@selector(saveServer:)];
}
