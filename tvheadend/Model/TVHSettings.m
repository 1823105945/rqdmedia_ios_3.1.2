...
- (void)setSelectedServer:(NSInteger)serverId {
    if ( serverId >= 0 && serverId < [self.availableServers count] ) {
        ...
        [defaults setInteger:[[self serverProperty:TVHS_VLC_NETWORK_LATENCY forServer:serverId] integerValue] forKey:krqdMediaSettingNetworkCaching];
        [defaults setInteger:[[self serverProperty:TVHS_VLC_DEINTERLACE forServer:serverId] integerValue] forKey:krqdMediaSettingDeinterlace];
        [defaults synchronize];
