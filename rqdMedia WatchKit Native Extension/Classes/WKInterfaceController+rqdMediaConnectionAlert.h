/*****************************************************************************
 * WKInterfaceController+rqdMediaConnectionAlert.h
 * rqdMedia for iOS
 *****************************************************************************
...
@interface WKInterfaceController (rqdMediaConnectionAlert)
/*+*
 * Same as method below, with nil as default okActionBlock
 ***/
- (void)rqdmedia_performBlockIfSessionReachable:(void(^__nullable)())reachableBlock
