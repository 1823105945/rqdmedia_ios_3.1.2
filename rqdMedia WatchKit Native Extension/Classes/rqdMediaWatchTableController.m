/*****************************************************************************
 * rqdMediaWatchTableController.m
 * rqdMedia for iOS
 *****************************************************************************
...
@interface rqdMediaWatchTableController()
...
@implementation rqdMediaWatchTableController
...
- (void)_configureTableCellAtIndex:(NSUInteger)index withObject:(id)object {
    rqdMediaWatchTableControllerConfigureRowControllerWithObjectBlock configureBlock = self.configureRowControllerWithObjectBlock;
