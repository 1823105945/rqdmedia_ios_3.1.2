/*****************************************************************************
 * rqdMediaWatchTableController.h
 * rqdMedia for iOS
 *****************************************************************************
...
typedef NSString *(^rqdMediaWatchTableControllerRowTypeForObjectBlock)(id object);
typedef void(^rqdMediaWatchTableControllerConfigureRowControllerWithObjectBlock)(id rowController, id object);

@interface rqdMediaWatchTableController : NSObject
...
@property (nonatomic, copy) rqdMediaWatchTableControllerRowTypeForObjectBlock rowTypeForObjectBlock;

@property (nonatomic, copy) rqdMediaWatchTableControllerConfigureRowControllerWithObjectBlock configureRowControllerWithObjectBlock;
