...
@interface rqdMediaPlaybackInfoMediaInfoTVViewController ()

@end

@implementation rqdMediaPlaybackInfoMediaInfoTVViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    if ([UIScreen mainScreen].traitCollection.userInterfaceStyle == UIUserInterfaceStyleDark) {
        UIColor *lightColor = [UIColor rqdMediaLightTextColor];
        self.titleLabel.textColor = lightColor;
        self.metaDataLabel.textColor = lightColor;
    } else {
        UIColor *darkColor = [UIColor rqdMediaDarkTextColor];
...
{
    self.titleLabel.text = [rqdMediaPlaybackController sharedInstance].metadata.title;
}
