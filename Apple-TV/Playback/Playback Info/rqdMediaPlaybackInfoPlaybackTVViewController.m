...
@interface rqdMediaPlaybackInfoPlaybackTVViewController ()
@property (nonatomic) NSArray<NSNumber*> *possibleRates;
@end

@implementation rqdMediaPlaybackInfoPlaybackTVViewController
...
- (IBAction)rateControlChanged:(UISegmentedControl *)sender
{
    ...
    [rqdMediaPlaybackController sharedInstance].playbackRate = newRate;
}

- (void)updateRepeatControl
{
    NSUInteger selectedIndex;
    VLCRepeatMode repeatMode = [rqdMediaPlaybackController sharedInstance].repeatMode;
    switch (repeatMode) {
...
-(IBAction)repeatControlChanged:(UISegmentedControl *)sender
{
    ...
    [rqdMediaPlaybackController sharedInstance].repeatMode = repeatMode;
}
