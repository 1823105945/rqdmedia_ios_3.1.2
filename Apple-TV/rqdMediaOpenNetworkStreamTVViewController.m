...
@interface rqdMediaOpenNetworkStreamTVViewController ()
{
...
@implementation rqdMediaOpenNetworkStreamTVViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    _recentURLs = [NSMutableArray arrayWithArray:[ubiquitousKeyValueStore arrayForKey:krqdMediaRecentURLs]];
    _recentURLTitles = [NSMutableDictionary dictionaryWithDictionary:[ubiquitousKeyValueStore dictionaryForKey:krqdMediaRecentURLTitles]];
...
- (void)setEditing:(BOOL)editing
{
    ...
    if (editing) {
        [focusedCell.layer addAnimation:[CAAnimation rqdmedia_wiggleAnimationwithSoftMode:YES]
