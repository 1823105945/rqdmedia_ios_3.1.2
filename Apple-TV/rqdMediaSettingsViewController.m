...
@interface rqdMediaSettingsViewController () <UITableViewDataSource, UITableViewDelegate>
{
...
@implementation rqdMediaSettingsViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([specifierType isEqualToString:kIASKPSMultiValueSpecifier]) {
        ...
        rqdMediaAboutViewController *targetViewController = [[rqdMediaAboutViewController alloc] initWithNibName:nil bundle:nil];
