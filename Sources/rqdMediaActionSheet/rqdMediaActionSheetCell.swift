...
class rqdMediaActionSheetCell: UICollectionViewCell {

    static let identifier = "rqdMediaActionSheetCell"
    ...
    private func setupViews() {
        backgroundColor = .rqdMediaDarkBackground()
