...
class KeychainCoordinator:NSObject, PAPasscodeViewControllerDelegate {
    ...
    private var touchIDEnabled:Bool {
        var touchIDEnabled = UserDefaults.standard.bool(forKey:krqdMediaSettingPasscodeAllowTouchID)
    ...
    private var faceIDEnabled:Bool {
        var faceIDEnabled = UserDefaults.standard.bool(forKey:krqdMediaSettingPasscodeAllowFaceID)
        let laContext = LAContext()
    ...
    static let passcodeService = "org.videolan.rqdmedia-ios.passcode"
