/*****************************************************************************
 * rqdMediaCloudStorageTableViewCell.m
 * rqdMedia for iOS
 *****************************************************************************
...
@implementation rqdMediaCloudStorageTableViewCell

+ (rqdMediaCloudStorageTableViewCell *)cellWithReuseIdentifier:(NSString *)ident
{
    NSArray *nibContentArray = [[NSBundle mainBundle] loadNibNamed:@"rqdMediaCloudStorageTableViewCell" owner:nil options:nil];
    NSAssert([nibContentArray count] == 1, @"meh");
    NSAssert([[nibContentArray lastObject] isKindOfClass:[rqdMediaCloudStorageTableViewCell class]], @"meh meh");
    rqdMediaCloudStorageTableViewCell *cell = (rqdMediaCloudStorageTableViewCell *)[nibContentArray lastObject];
