/*****************************************************************************
 * rqdMediaPlaybackController+MediaLibrary.m
 * rqdMedia for iOS
 *****************************************************************************
...
@implementation rqdMediaPlaybackController (MediaLibrary)
...
- (void)configureWithShowEpisode:(MLShowEpisode *)showEpisode
{
    ...
    if (![defaults boolForKey:krqdMediaAutomaticallyPlayNextItem]) {
