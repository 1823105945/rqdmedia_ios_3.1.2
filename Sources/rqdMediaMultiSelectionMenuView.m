//
//  rqdMediaMultiSelectionMenuView.m
//  rqdMedia for iOS
//
...
@interface rqdMediaMultiSelectionMenuView ()
{
    BOOL _showsEQ;
}
...
@implementation rqdMediaMultiSelectionMenuView
...
{
    if (displayLock)
        [_lockButton setBackgroundColor:[UIColor rqdMediaOrangeTintColor]];
    else
...
{
    if (shuffleMode)
        [_shuffleButton setBackgroundColor:[UIColor rqdMediaOrangeTintColor]];
    else
