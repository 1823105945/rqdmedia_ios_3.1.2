...
NSString * const krqdMediaNetworkLoginViewFieldCellIdentifier = @"rqdMediaNetworkLoginViewFieldCellIdentifier";

@interface rqdMediaNetworkLoginViewFieldCell () <UITextFieldDelegate>
@end

@implementation rqdMediaNetworkLoginViewFieldCell
...
{
    UIColor *color = [UIColor rqdMediaLightTextColor];
