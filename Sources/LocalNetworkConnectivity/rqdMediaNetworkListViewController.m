...
NSString *rqdMediaNetworkListCellIdentifier = @"rqdMediaNetworkListCellIdentifier";

@interface rqdMediaNetworkListViewController () <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating>
{
...
@implementation rqdMediaNetworkListViewController
...
- (void)loadView
{
    ...
    _tableView.rowHeight = [rqdMediaNetworkListCell heightOfCell];
