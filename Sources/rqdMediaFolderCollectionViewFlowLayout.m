/*****************************************************************************
 * rqdMediaFolderCollectionViewFlowLayout.m
 * rqdMedia for iOS
 *****************************************************************************
...
@interface UICollectionViewCell (rqdMediaFolderCollectionViewLayout)

- (UIImage *)LX_rasterizedImage;

@end

@implementation UICollectionViewCell (rqdMediaFolderCollectionViewLayout)
...
@interface rqdMediaFolderCollectionViewFlowLayout ()
{
...
@implementation rqdMediaFolderCollectionViewFlowLayout
...
- (id<rqdMediaFolderCollectionViewDelegateFlowLayout>)delegate {
    return (id<rqdMediaFolderCollectionViewDelegateFlowLayout>)self.collectionView.delegate;
}
...
- (void)invalidateLayoutIfNecessary {
    ...
    if (!_folderView) {
        ...
        _folderView.backgroundColor = [UIColor rqdMediaOrangeTintColor];
