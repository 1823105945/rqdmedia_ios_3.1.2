/*****************************************************************************
 * rqdMediaMovieViewControlPanelView.m
 * rqdMedia for iOS
 *****************************************************************************
...
@interface rqdMediaMovieViewControlPanelView ()
...
@property (nonatomic, strong) rqdMediaPlaybackController *playbackController;
@end

@implementation rqdMediaMovieViewControlPanelView
...
- (void)setupSubviews
{
    ...
    _volumeView = [[rqdMediaVolumeView alloc] initWithFrame:CGRectZero];
