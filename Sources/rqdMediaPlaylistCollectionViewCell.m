/*****************************************************************************
 * rqdMediaPlaylistCollectionViewCell.m
 * rqdMedia for iOS
 *****************************************************************************
...
@interface rqdMediaPlaylistCollectionViewCell ()
{
...
@implementation rqdMediaPlaylistCollectionViewCell
...
- (void)_updatedDisplayedInformationForKeyPath:(NSString *)keyPath
{
    ...
    if ([self.mediaObject isKindOfClass:[MLFile class]]) {
        ...
        if ([keyPath isEqualToString:@"computedThumbnail"] || [keyPath isEqualToString:@"episodes"] || !keyPath || (!self.thumbnailView.image && [keyPath isEqualToString:@"editing"])) {
            self.thumbnailView.image = [rqdMediaThumbnailsCache thumbnailForManagedObject:mediaObject];
        }
    ...
    if (![self.mediaObject isKindOfClass:[MLShow class]] && ([keyPath isEqualToString:@"computedThumbnail"] || !keyPath || (!self.thumbnailView.image && [keyPath isEqualToString:@"editing"]))) {
        self.thumbnailView.image = [rqdMediaThumbnailsCache thumbnailForManagedObject:self.mediaObject];
    }
...
{
    self.thumbnailView.contentMode = UIViewContentModeScaleAspectFill;
    self.thumbnailView.image = [rqdMediaThumbnailsCache thumbnailForManagedObject:self.mediaObject refreshCache:YES];
}
