...
@interface rqdMediaThumbnailsCache() {
...
@implementation rqdMediaThumbnailsCache
...
+ (instancetype)sharedThumbnailCache
{
    ...
    static rqdMediaThumbnailsCache *sharedThumbnailCache;
    dispatch_once(&onceToken, ^{
        sharedThumbnailCache = [[rqdMediaThumbnailsCache alloc] init];
    });
...
{
    UIImage *thumbnail;
    rqdMediaThumbnailsCache *cache = [rqdMediaThumbnailsCache sharedThumbnailCache];
...
+ (UIImage *)thumbnailForManagedObject:(NSManagedObject *)object refreshCache:(BOOL)refreshCache toFitRect:(CGRect)rect scale:(CGFloat)scale shouldReplaceCache:(BOOL)replaceCache;
{
    ...
    if (replaceCache)
        [[rqdMediaThumbnailsCache sharedThumbnailCache] _setThumbnail:scaledImage forObjectId:object.objectID];
