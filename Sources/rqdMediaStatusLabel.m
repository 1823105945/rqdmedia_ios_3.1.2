...
@interface rqdMediaStatusLabel ()
{
    NSTimer *_displayTimer;
}
@end

@implementation rqdMediaStatusLabel
...
{
    UIColor *drawingColor = [UIColor rqdMediaTransparentDarkBackgroundColor];
