/*****************************************************************************
 * rqdMediaWiFiUploadTableViewCell.m
 * rqdMedia for iOS
 *****************************************************************************
...
@interface rqdMediaWiFiUploadTableViewCell()
...
@implementation rqdMediaWiFiUploadTableViewCell
...
- (void)setupCell
{
    ...
    self.titleLabel.shadowColor = [UIColor rqdMediaDarkTextShadowColor];
    ...
    self.backgroundColor = [UIColor rqdMediaMenuBackgroundColor];
    ...
    self.uploadAddressLabel.shadowColor = [UIColor rqdMediaDarkTextShadowColor];
...
- (void)updateHTTPServerAddress
{
    ...
    BOOL connectedViaWifi = [[rqdMediaHTTPUploaderController sharedInstance] isReachable];
