...
@interface rqdMediaEqualizerView ()
{
    rqdMediaSlider *_preAmp_slider;
    rqdMediaSlider *_60_slider;
    rqdMediaSlider *_170_slider;
    rqdMediaSlider *_310_slider;
    rqdMediaSlider *_600_slider;
    rqdMediaSlider *_1K_slider;
    rqdMediaSlider *_3K_slider;
    rqdMediaSlider *_6K_slider;
    rqdMediaSlider *_12K_slider;
    rqdMediaSlider *_14K_slider;
    rqdMediaSlider *_16K_slider;
}

@end

@implementation rqdMediaEqualizerView
...
#define spacer 8.
    ...
    _preAmp_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(-sliderWidth + horizontal_padding, sliderY, sliderHeight, sliderWidth)];
    ...
    _60_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 3. + sliderWidth, sliderY, sliderHeight, sliderWidth)];
    ...
    _170_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 4. + sliderWidth * 2, sliderY, sliderHeight, sliderWidth)];
    ...
    _310_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 5. + sliderWidth * 3., sliderY, sliderHeight, sliderWidth)];
    ...
    _600_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 6. + sliderWidth * 4., sliderY, sliderHeight, sliderWidth)];
    ...
    _1K_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 7. + sliderWidth * 5., sliderY, sliderHeight, sliderWidth)];
    ...
    _3K_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 8. + sliderWidth * 6., sliderY, sliderHeight, sliderWidth)];
    ...
    _6K_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 9. + sliderWidth * 7., sliderY, sliderHeight, sliderWidth)];
    ...
    _12K_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 10. + sliderWidth * 8., sliderY, sliderHeight, sliderWidth)];
    ...
    _14K_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 11. + sliderWidth * 9., sliderY, sliderHeight, sliderWidth)];
    ...
    _16K_slider = [[rqdMediaSlider alloc] initWithFrame:CGRectMake(horizontal_padding * 12. + sliderWidth * 10., sliderY, sliderHeight, sliderWidth)];
    ...
    [_tableView registerClass:[rqdMediaTrackSelectorHeaderView class] forHeaderFooterViewReuseIdentifier:PROFILE_SELECTOR_TABLEVIEW_SECTIONHEADER];
    [_tableView registerClass:[rqdMediaTrackSelectorTableViewCell class] forCellReuseIdentifier:PROFILE_SELECTOR_TABLEVIEW_CELL];
...
- (IBAction)sliderChangedValue:(rqdMediaSlider *)sender
{
    if (self.delegate)
...
- (IBAction)preampSliderChangedValue:(rqdMediaSlider *)sender
{
    if (self.delegate)
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (!view)
        view = [[rqdMediaTrackSelectorHeaderView alloc] initWithReuseIdentifier:PROFILE_SELECTOR_TABLEVIEW_SECTIONHEADER];
...
{
    rqdMediaTrackSelectorTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:PROFILE_SELECTOR_TABLEVIEW_CELL];

    if (!cell)
        cell = [[rqdMediaTrackSelectorTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:PROFILE_SELECTOR_TABLEVIEW_CELL];
