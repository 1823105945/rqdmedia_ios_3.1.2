/*****************************************************************************
 * rqdMediaRemoteBrowsingTVCell+CloudStorage.m
 * rqdMedia for tvOS
 *****************************************************************************
...
@implementation rqdMediaRemoteBrowsingTVCell (CloudStorage)
...
- (void)_updateOneDriveRepresentation:(rqdMediaOneDriveObject *)oneDriveFile
{
    if (oneDriveFile != nil) {
