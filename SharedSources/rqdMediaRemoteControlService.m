/*****************************************************************************
 * rqdMediaRemoteControlService.m
 * rqdMedia for iOS
 *****************************************************************************
...
@implementation rqdMediaRemoteControlService
...
- (void)subscribeToRemoteCommands
{
    ...
    NSNumber *forwardSkip = [defaults valueForKey:krqdMediaSettingPlaybackForwardSkipLength];
    commandCenter.skipForwardCommand.preferredIntervals = @[forwardSkip];
    NSNumber *backwardSkip = [defaults valueForKey:krqdMediaSettingPlaybackBackwardSkipLength];
