/*****************************************************************************
 * rqdMediaNetworkServerBrowserVLCMedia.m
 * rqdMedia for iOS
 *****************************************************************************
...
@interface rqdMediaNetworkServerBrowserVLCMedia () <VLCMediaListDelegate, VLCMediaDelegate>
{
...
@property (nonatomic) NSMutableArray<id<rqdMediaNetworkServerBrowserItem>> *mutableItems;
@property (nonatomic, readonly) NSDictionary *mediaOptions;

@end
@implementation rqdMediaNetworkServerBrowserVLCMedia
...
- (void)_addMediaListRootItemsToList
{
    ...
    for (NSUInteger i = 0; i < count; i++) {
        ...
        if (![self shouldFilterMedia:media]) {
            ...
            [self.mutableItems insertObject:[[rqdMediaNetworkServerBrowserItemVLCMedia alloc] initWithMedia:media options:self.mediaOptions] atIndex:mediaIndex];
        }
    }
    [rootItems unlock];
}
...
@interface rqdMediaNetworkServerBrowserItemVLCMedia () <VLCMediaDelegate>
@property (nonatomic, readonly) NSDictionary *mediaOptions;

@end
@implementation rqdMediaNetworkServerBrowserItemVLCMedia
...
- (id<rqdMediaNetworkServerBrowser>)containerBrowser {
    return [[rqdMediaNetworkServerBrowserVLCMedia alloc] initWithMedia:self.media options:self.mediaOptions];
}
