...
static NSString *const kPlexrqdMediaDeviceName = @"rqdMedia for iOS";

@interface rqdMediaPlexParser () <NSXMLParserDelegate>
{
...
@implementation rqdMediaPlexParser
            ...
            if (keychainItem) {
                ...
                if ([response statusCode] != 200) {
                    if (outError) {
                        ...
                        *outError = [NSError errorWithDomain:@"org.videolan.rqdmedia-ios.plexParser"
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qualifiedName attributes:(NSDictionary *)attributeDict
{
    ...
    } else if ([elementName isEqualToString:@"Device"] && [[attributeDict objectForKey:@"name"] isEqualToString:kPlexrqdMediaDeviceName]) {
